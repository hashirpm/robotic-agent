...
import "../script/utils/RoboticAgentDeploymentLib.sol";
import "@eigenlayer/contracts/interfaces/IRewardsCoordinator.sol";
import "../src/IRoboticAgentServiceManager.sol";
...
import "../script/RoboticAgentDeployer.s.sol";
import {StrategyFactory} from "@eigenlayer/contracts/strategies/StrategyFactory.sol";
import {RoboticAgentTaskManagerSetup} from "test/RoboticAgentServiceManager.t.sol";
...
contract SetupPaymentsLibTest is Test, TestConstants, RoboticAgentTaskManagerSetup {
    using SetupPaymentsLib for *;
    Vm cheats = Vm(VM_ADDRESS);


    IRewardsCoordinator public rewardsCoordinator;
    IRoboticAgentServiceManager public roboticAgentServiceManager;
    ...
    function setUp() public override virtual {
        ...
        ECDSAServiceManagerBase(roboticAgentDeployment.roboticAgentServiceManager).setRewardsInitiator(rewardsInitiator);
    ...
    function testCreateAVSRewardsSubmissions() public {
        ...
        mockToken.increaseAllowance(roboticAgentDeployment.roboticAgentServiceManager, amountPerPayment * numPayments);

        cheats.startPrank(rewardsInitiator);
        SetupPaymentsLib.createAVSRewardsSubmissions(
            address(roboticAgentDeployment.roboticAgentServiceManager),
            address(strategy),
            numPayments,
            amountPerPayment,
            duration,
