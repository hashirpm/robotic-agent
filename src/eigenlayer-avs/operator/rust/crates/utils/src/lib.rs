...
pub struct RoboticAgentData {
    #[serde(rename = "lastUpdate")]
    last_update: LastUpdate,
    pub addresses: RoboticAgentAddresses,
}
...
#[allow(unused)]
#[derive(Deserialize, Debug)]
pub struct RoboticAgentAddresses {
    #[serde(rename = "proxyAdmin")]
    _proxy_admin: String,
    #[serde(rename = "roboticAgentServiceManager")]
    pub hello_world_service_manager: String,
    #[serde(rename = "roboticAgentServiceManagerImpl")]
