...
library SetupPaymentsLib {
    ...
    function createAVSRewardsSubmissions(
        ...
        ECDSAServiceManagerBase(roboticAgentServiceManager).createAVSRewardsSubmission(rewardsSubmissions);
    }
    ...
    function createOperatorDirectedAVSRewardsSubmissions(
        ...
        ECDSAServiceManagerBase(roboticAgentServiceManager).createOperatorDirectedAVSRewardsSubmission(rewardsSubmissions);
    }
